        ...
        <div class="col-md-10">
            <div class="card shadow-sm border-0">
                <div class="card-body p-5">
                    <h2 class="font-weight-bold mb-4 text-primary">Kebijakan Privasi PT APOTIK SIS JAYA EUY</h2>
                    <p class="text-muted"><strong>Tanggal Berlaku:</strong> 12 Maret 2026</p>
                    <p class="text-muted"><strong>Terakhir Diperbarui:</strong> 12 Maret 2026</p>
                    ...
                    <div class="content-text">
                        ...
                        <ul>
                            ...
                            <li>Nomor telepon atau nomor handphone;</li>
                            <li>Data transaksi, pembayaran, pembelian, pengiriman, dan riwayat pesanan;</li>
                        ...
                        <div class="bg-light p-3 rounded">
                            ...
                            Alamat: Jl. HOS. Cokroaminoto No.1, Gondangdia, Jakarta Pusat<br>
                            Email: admin@apotik-sis.co.id<br>
                            Nomor layanan pelanggan: 089523429806</p>
                        </div>
                    </div>
                </div>
            </div>
